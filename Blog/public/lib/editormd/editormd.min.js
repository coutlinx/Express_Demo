...
!(function (e) {
  ...
  if ("undefined" != typeof e) {
    ...
    (t.title = t.$name = "Editor.md"),
      ...
      (t.classNames = { tex: t.classPrefix + "tex" }),
    ...
    (t.prototype = t.fn =
      {
        ...
        init: function (i, o) {
          ...
          (n.pluginPath =
            "" === n.pluginPath ? n.path + "../plugins/" : n.pluginPath),
          ...
          l.length < 1 &&
            (a.append("<textarea></textarea>"),
            (l = this.markdownTextarea = a.children("textarea"))),
            l.addClass(s.textarea.markdown).attr("placeholder", n.placeholder),
            ("undefined" == typeof l.attr("name") || "" === l.attr("name")) &&
              l.attr("name", "" !== n.name ? n.name : i + "-markdown-doc");
          var c = [
            n.readOnly
              ? ""
          ...
          return (
            a.append(c).addClass(r + "vertical"),
            ...
            "" !== n.previewTheme &&
              this.preview.addClass(r + "preview-theme-" + n.previewTheme),
            "function" == typeof define &&
              define.amd &&
              ("undefined" != typeof katex && (t.$katex = katex),
              n.searchReplace &&
                !n.readOnly &&
                (t.loadCSS(n.path + "codemirror/addon/dialog/dialog"),
                t.loadCSS(
                  n.path + "codemirror/addon/search/matchesonscrollbar"
                ))),
            ("function" == typeof define && define.amd) || !n.autoLoadModules
        ...
        loadQueues: function () {
          var e = this,
            ...
            r = function () {
              return t.isIE8
                ? void e.loadedDisplay()
                : void (i.flowChart || i.sequenceDiagram
                    ? t.loadScript(o + "raphael.min", function () {
                        t.loadScript(o + "underscore.min", function () {
                          !i.flowChart && i.sequenceDiagram
                            ? t.loadScript(
                                o + "sequence-diagram.min",
                                function () {
                                  e.loadedDisplay();
                                }
                              )
                            : i.flowChart && !i.sequenceDiagram
                            ? t.loadScript(o + "flowchart.min", function () {
                                t.loadScript(
                                  o + "jquery.flowchart.min",
                                  function () {
                                    e.loadedDisplay();
                                  }
                                );
          ...
          return (
            t.loadCSS(o + "codemirror/codemirror.min"),
            i.searchReplace &&
              !i.readOnly &&
              (t.loadCSS(o + "codemirror/addon/dialog/dialog"),
              ...
              (t.$CodeMirror = CodeMirror),
                t.loadScript(o + "codemirror/modes.min", function () {
                  t.loadScript(o + "codemirror/addons.min", function () {
                    return (
                      e.setCodeMirror(),
                      "gfm" !== i.mode && "markdown" !== i.mode
                        ? (e.loadedDisplay(), !1)
                        : (e.setToolbar(),
                          void t.loadScript(o + "marked.min", function () {
                            (t.$marked = marked),
                              i.previewCodeHighlight
                                ? t.loadScript(o + "prettify.min", function () {
                                    r();
                                  })
                                : r();
                          }))
        ...
        setTheme: function (e) {
          ...
          return (
            t.removeClass(o + i).addClass(o + e),
        ...
        setEditorTheme: function (e) {
          ...
          return (
            (i.editorTheme = e),
            "default" !== e &&
              t.loadCSS(i.path + "codemirror/theme/" + i.editorTheme),
        ...
        setCodeMirror: function () {
          var e = this.settings,
            i = this.editor;
          "default" !== e.editorTheme &&
            t.loadCSS(e.path + "codemirror/theme/" + e.editorTheme);
          var o = {
            mode: e.mode,
            theme: e.editorTheme,
            tabSize: e.tabSize,
          ...
          return (
            (this.codeEditor = this.cm =
              t.$CodeMirror.fromTextArea(this.markdownTextarea[0], o)),
        ...
        gotoLine: function (t) {
          ...
          if (
            ("string" == typeof t &&
              ("last" === t && (t = r), "first" === t && (t = 1)),
            "number" != typeof t)
          )
            return alert("Error: The line number must be an integer."), this;
          if (((t = parseInt(t) - 1), t > r))
            return alert("Error: The line number range 1-" + r), this;
          ...
          return (
            "undefined" != typeof arguments[1] &&
              ("function" == typeof arguments[1] &&
                (arguments[1] = e.proxy(arguments[1], this)),
              (this[arguments[0]] = arguments[1])),
            "object" == typeof arguments[0] &&
              "undefined" == typeof arguments[0].length &&
              e.extend(!0, this, arguments[0]),
            this
          );
        },
        set: function (t, i) {
        ...
        config: function (t, i) {
          var o = this.settings;
          return (
            "object" == typeof t && (o = e.extend(!0, o, t)),
        ...
        on: function (t, i) {
          var o = this.settings;
          return (
            "undefined" != typeof o["on" + t] &&
              (o["on" + t] = e.proxy(i, this)),
            this
          );
        },
        off: function (e) {
          var t = this.settings;
          return (
            "undefined" != typeof t["on" + e] && (t["on" + e] = function () {}),
            this
          );
        },
        ...
        setToolbarAutoFixed: function (t) {
          ...
          var a = function () {
            var t = e(window),
              i = t.scrollTop();
            return n.toolbarAutoFixed
              ? void r.css(
                  i - o.offset().top > 10 && i < o.height()
                    ? {
                        position: "fixed",
                        width: o.width() + "px",
        ...
        setToolbar: function () {
          ...
          for (
            var a =
                "function" == typeof e.toolbarIcons
                  ? e.toolbarIcons()
                  : "string" == typeof e.toolbarIcons
                  ? t.toolbarModes[e.toolbarIcons]
                  : e.toolbarIcons,
              s = r.find("." + this.classPrefix + "menu"),
              l = "",
              c = !1,
              h = 0,
              d = a.length;
            ...
            if ("||" === u) c = !0;
              ...
              "undefined" != typeof e.toolbarCustomIcons[u] &&
              "function" != typeof e.toolbarCustomIcons[u]
                ? (v += e.toolbarCustomIcons[u])
                : ((v +=
          ...
          return (
            ...
            s
              ...
              .attr("title", e.lang.toolbar.lowercase),
        ...
        setToolbarHandler: function () {
          ...
          return (
            s.bind(t.mouseOrTouch("click", "touchend"), function (t) {
              ...
              return "" !== a
                ? ((i.activeIcon = r),
                  "undefined" != typeof l[a]
                    ? e.proxy(l[a], i)(n)
                    : "undefined" != typeof o.toolbarHandlers[a] &&
                      e.proxy(o.toolbarHandlers[a], i)(n, r, s, c),
                  "link" !== a &&
                    "reference-link" !== a &&
                    "image" !== a &&
                    "code-block" !== a &&
        ...
        createInfoDialog: function () {
          var e = this,
            ...
            o = this.classPrefix,
            r = [
              '<div class="' + o + "dialog " + o + 'dialog-info" style="">',
          ...
          return (
            n
              .find("." + o + "dialog-close")
              .bind(t.mouseOrTouch("click", "touchend"), function () {
                e.hideInfoDialog();
              }),
            n
              .css("border", t.isIE8 ? "1px solid #ddd" : "")
              .css("z-index", t.dialogZindex)
              .show(),
        ...
        showInfoDialog: function () {
          ...
          var i = this.editor,
            o = this.settings,
            r = (this.infoDialog = i.children(
              "." + this.classPrefix + "dialog-info"
            ));
          return (
            r.length < 1 && this.createInfoDialog(),
            this.lockScreen(!0),
            this.mask
              .css({
        ...
        recreate: function () {
          ...
          return (
            ...
            this.setCodeMirror(),
            t.readOnly ||
              (e.find(".editormd-dialog").length > 0 &&
                e.find(".editormd-dialog").remove(),
              t.toolbar && (this.getToolbarHandles(), this.setToolbar())),
        ...
        previewCodeHighlight: function () {
          ...
          return (
            e.previewCodeHighlight &&
              (t.find("pre").addClass("prettyprint linenums"),
        ...
        flowChartAndSequenceDiagramRender: function () {
          ...
          r.sequenceDiagram &&
            n.find(".sequence-diagram").sequenceDiagram({ theme: "simple" });
          var a = i.preview,
            s = i.codeMirror,
          ...
          return (
            ...
            a.scrollTop(
              0 === h
                ? 0
                : h + c >= l[0].scrollHeight - 16
                ? a[0].scrollHeight
                : (a[0].scrollHeight + u + f) * d
            ),
            this
          );
        },
        ...
        bindScrollEvent: function () {
                ...
                function (t) {
                  ...
                  (c = c ? c : 0),
                    o.scrollTop(
                      0 === a
                        ? 0
                        : a + n >= e(this)[0].scrollHeight - 16
                        ? o[0].scrollHeight
                        : (o[0].scrollHeight + l + c) * s
                    ),
          ...
          return (
            n.bind({ mouseover: s, mouseout: l, touchstart: s, touchend: l }),
            "single" === r.syncScrolling
              ? this
              : (o.bind({
                  mouseover: c,
                  mouseout: h,
        ...
        bindChangeEvent: function () {
          var e = this,
            t = this.cm,
            o = this.settings;
          return o.syncScrolling
            ? (t.on("change", function (t, r) {
                o.watch &&
                  e.previewContainer.css(
                    "padding",
                    o.autoHeight ? "20px 20px 50px 40px" : "20px"
                  ),
        ...
        width: function (e) {
          return (
            this.editor.css("width", "number" == typeof e ? e + "px" : e),
            this.resize(),
            this
          );
        },
        height: function (e) {
          return (
            this.editor.css("height", "number" == typeof e ? e + "px" : e),
            this.resize(),
            this
          );
        },
        resize: function (t, i) {
          ...
          var o = this.state,
            ...
            l = this.codeMirror;
          if (
            (t && r.css("width", "number" == typeof t ? t + "px" : t),
            !s.autoHeight || o.fullscreen || o.preview
              ? (i && r.css("height", "number" == typeof i ? i + "px" : i),
                o.fullscreen && r.height(e(window).height()),
                s.toolbar && !s.readOnly
                  ? l
                      .css("margin-top", a.height() + 1)
                      .height(r.height() - a.height())
                  : l.css("margin-top", 0).height(r.height()))
              : (r.css("height", "auto"), l.css("height", "auto")),
            s.watch)
          )
            if (
              (l.width(r.width() / 2),
              ...
              this.previewContainer.css(
                "padding",
                s.autoHeight ? "20px 20px 50px 40px" : "20px"
              ),
              s.toolbar && !s.readOnly
                ? n.css("top", a.height() + 1)
                : n.css("top", 0),
              !s.autoHeight || o.fullscreen || o.preview)
            ) {
              var c =
                s.toolbar && !s.readOnly ? r.height() - a.height() : r.height();
              n.height(c);
            } else n.height("");
        ...
        save: function () {
          ...
          if ("gfm" !== a.mode && "markdown" !== a.mode)
            return this.markdownTextarea.val(l), this;
          var h = t.$marked,
            d = (this.markdownToC = []),
          ...
          var g = t.$marked(l, f);
          if (
            ((g = t.filterHTMLTags(g, a.htmlDecode)),
            ...
            if ((c.html(g), this.previewCodeHighlight(), a.toc)) {
              ...
              p.attr(
                "previewContainer",
                "" === a.tocContainer ? "true" : "false"
              ),
                "" !== a.tocContainer && m.length > 0 && m.remove(),
                t.markdownToCRenderer(d, p, a.tocDropdown, a.tocStartLevel),
                (a.tocDropdown ||
                  p.find("." + this.classPrefix + "toc-menu").length > 0) &&
                  t.tocDropdownMenu(
                    p,
                    "" !== a.tocTitle ? a.tocTitle : this.lang.tocTitle
                  ),
                "" !== a.tocContainer &&
                  c.find(".markdown-toc").css("border", "none");
            }
            a.tex &&
              (!t.kaTeXLoaded && a.autoLoadModules
                ? t.loadKaTeX(function () {
                    (t.$katex = katex), (t.kaTeXLoaded = !0), r.katexRender();
                  })
                : ((t.$katex = katex), this.katexRender())),
              (a.flowChart || a.sequenceDiagram) &&
        ...
        previewing: function () {
          ...
          a.toolbar &&
            n &&
            (n.toggle(), n.find(".fa[name=preview]").toggleClass("active")),
            s.toggle();
          var c = function (e) {
            ...
            ? ((this.state.preview = !0),
              ...
              r
                ...
                .css({
                  ...
                  width: o.width(),
                  height:
                    a.autoHeight && !this.state.fullscreen
                      ? "auto"
                      : o.height(),
                }),
              this.state.loaded && e.proxy(a.onpreviewing, this)(),
              e(window).bind("keyup", c))
            : (e(window).unbind("keyup", c), this.previewed());
        },
        previewed: function () {
          var i = this.editor,
            o = this.preview,
          ...
          return (
            ...
            o.css({
              ...
              width: i.width() / 2,
              height:
                n.autoHeight && !this.state.fullscreen
                  ? "auto"
                  : i.height() - r.height(),
        ...
        fullscreen: function () {
          ...
          var s = function (e) {
            e.shiftKey ||
              27 !== e.keyCode ||
              (i.fullscreen && t.fullscreenExit());
          };
          return (
            o.hasClass(a)
              ? (e(window).unbind("keyup", s), this.fullscreenExit())
              : ((i.fullscreen = !0),
                e("html,body").css("overflow", "hidden"),
                o
                  .css({ width: e(window).width(), height: e(window).height() })
                  .addClass(a),
                this.resize(),
        ...
        fullscreenExit: function () {
          ...
          return (
            ...
            t
              .css({ width: t.data("oldWidth"), height: t.data("oldHeight") })
              .removeClass(r),
            this.resize(),
            ...
            "function" == typeof define
              ? "undefined" == typeof this[i]
                ? (alert(
                  ...
                  this)
                : (this[i](n), this)
              : (e.inArray(o, t.loadFiles.plugin) < 0
                  ? t.loadPlugin(o, function () {
        ...
        search: function (e) {
          var t = this.settings;
          return t.searchReplace
            ? (t.readOnly || this.cm.execCommand(e || "find"), this)
      ...
      (t.dialogLockScreen = function () {
        ...
        t.dialogLockScreen &&
          (e("html,body").css("overflow", "hidden"), this.resize());
      }),
        ...
        t.css({
          ...
          o.dialogShowMask &&
            i
              ...
              .css("z-index", parseInt(t.css("z-index")) - 1)
              .show();
      }),
      (t.toolbarHandlers = {
        undo: function () {
        ...
        quote: function () {
          var e = this.cm,
            ...
            i = e.getSelection();
          0 !== t.ch
            ? (e.setCursor(t.line, 0),
              e.replaceSelection("> " + i),
              e.setCursor(t.line, t.ch + 2))
            : e.replaceSelection("> " + i);
        },
        ucfirst: function () {
          var e = this.cm,
        ...
        datetime: function () {
          var e = this.cm,
            ...
            o =
              ...
              " " +
              t.dateFormat(
                "zh-cn" === i || "zh-tw" === i ? "cn-week-day" : "week-day"
              );
      ...
      (t.keyMaps = {
        ...
        "Ctrl-E": function () {
          ...
          return this.settings.emoji
            ? (e.replaceSelection(":" + i + ":"),
              void ("" === i && e.setCursor(t.line, t.ch + 1)))
            : void alert("Error: settings.emoji == false");
        },
        ...
        "Shift-Ctrl-A": function () {
          ...
          return this.settings.atLink
            ? (e.replaceSelection("@" + i),
              void ("" === i && e.setCursor(t.line, t.ch + 1)))
            : void alert("Error: settings.atLink == false");
        },
        "Shift-Ctrl-C": "code",
        "Shift-Ctrl-Q": "quote",
        "Shift-Ctrl-S": "del",
    ...
    return (
      (t.firstUpperCase = t.ucfirst = a),
      (t.urls = { atLinkBase: "https://github.com/" }),
      (t.regexs = {
        atLink: /@(\w+)/g,
        email: /(\w+)@(\w+)\.(\w+)\.?(\w+)?/g,
      ...
      (t.twemoji = { path: "http://twemoji.maxcdn.com/36x36/", ext: ".png" }),
      (t.markedRenderer = function (i, o) {
        ...
        return (
                  ...
                  if (o)
                    ...
                    if (l)
                      ...
                      if (!c) {
                        var f = "+1" === r ? "plus1" : r;
                        return (
                          (f = "black_large_square" === f ? "black_square" : f),
          ...
          (l.atLink = function (i) {
            return h.test(i)
              ? (a.atLink &&
                  ((i = i.replace(u, function (e, t, i, o) {
                    return e.replace(/@/g, "_#_&#64;_#_");
                  })),
                  (i = i
                    .replace(h, function (e, i) {
                      return (
                        '<a href="' +
                        t.urls.atLinkBase +
                        i +
                    ...
                    .replace(/_#_&#64;_#_/g, "@"))),
                a.emailLink &&
                  (i = i.replace(f, function (t, i, o, r, n) {
                    return !i &&
                      e.inArray(
                        n,
          ...
          (l.link = function (e, t, i) {
            if (this.options.sanitize) {
              try {
                var o = decodeURIComponent(unescape(e))
                  .replace(/[^\w:]/g, "")
                  .toLowerCase();
              } catch (r) {
                return "";
            ...
            var n = '<a href="' + e + '"';
            return h.test(t) || h.test(i)
              ? (t && (n += ' title="' + t.replace(/@/g, "&#64;")),
                n + '">' + i.replace(/@/g, "&#64;") + "</a>")
              : (t && (n += ' title="' + t + '"'), (n += ">" + i + "</a>"));
          }),
          (l.heading = function (e, t, o) {
            ...
            var g =
              ...
              '">';
            return (
              (g += '<a name="' + e + '" class="reference-link"></a>'),
          ...
          (l.paragraph = function (e) {
            ...
            e =
              !o && i
                ...
                : e;
            var l =
              '<div class="markdown-toc editormd-markdown-toc">' + e + "</div>";
            return n
              ? s
                ? '<div class="editormd-toc-menu">' + l + "</div><br/>"
                : l
              : w.test(e)
              ? this.pageBreak(e)
              : "<p" + r + ">" + this.atLink(this.emoji(e)) + "</p>\n";
          }),
          (l.code = function (e, i, o) {
            return "seq" === i || "sequence" === i
              ? '<div class="sequence-diagram">' + e + "</div>"
              : "flow" === i
              ? '<div class="flowchart">' + e + "</div>"
              : "math" === i || "latex" === i || "katex" === i
              ? '<p class="' + t.classNames.tex + '">' + e + "</p>"
              : s.Renderer.prototype.code.apply(this, arguments);
          }),
          (l.tablecell = function (e, t) {
            var i = t.header ? "th" : "td",
              o = t.align
                ? "<" + i + ' style="text-align:' + t.align + '">'
                : "<" + i + ">";
            return o + this.atLink(this.emoji(e)) + "</" + i + ">\n";
          }),
          (l.listitem = function (e) {
            return a.taskList && /^\s*\[[x\s]\]\s*/.test(e)
              ? ((e = e
                  .replace(
                    /^\s*\[\s\]\s*/,
                ...
                '<li style="list-style: none;">' +
                  ...
                  "</li>")
              : "<li>" + this.atLink(this.emoji(e)) + "</li>";
          }),
          l
        );
      }),
      (t.markdownToCRenderer = function (e, t, i, o) {
        ...
        return (
          i && d.wrap('<div class="' + a + 'toc-menu"></div><br/>'),
          d
        ...
        return (
          r.each(function () {
            var t = e(this),
              ...
              a =
                '<a href="javascript:;" class="toc-menu-btn">' + n + i + "</a>",
              s = r.children("ul"),
              l = s.find("li");
            r.append(a),
                  ...
                  s.show(),
                    l.each(function () {
                      ...
                      if (
                        ...
                        r.children(".fa").length < 1 &&
                          r.append(
                            e(n).css({ float: "right", paddingTop: "4px" })
                          );
                      }
      ...
      (t.filterHTMLTags = function (t, i) {
        if (("string" != typeof t && (t = new String(t)), "string" != typeof i))
          return t;
        for (
          var o = i.split("|"),
            r = o[0].split(","),
        ...
        if ("undefined" != typeof n) {
          ...
          t =
            "*" === n
              ? t.replace(c, function (e, t, i, o, r) {
                  return "<" + t + ">" + o + "</" + r + ">";
                })
              : "on*" === n
              ? t.replace(c, function (t, i, o, r, n) {
                  var a = e("<" + i + ">" + r + "</" + n + ">"),
                    s = e(t)[0].attributes,
                    l = {};
      ...
      (t.markdownToHTML = function (i, o) {
        ...
        var n = e("#" + i),
          ...
          s = n.find("textarea");
        s.length < 1 &&
          (n.append("<textarea></textarea>"), (s = n.find("textarea")));
        ...
        if (
          ("" !== a.tocContainer && f.attr("previewContainer", !1),
          a.toc &&
            ((n.tocContainer = this.markdownToCRenderer(
              c,
              f,
              a.tocDropdown,
              a.tocStartLevel
            ...
            (a.tocDropdown ||
              n.find("." + this.classPrefix + "toc-menu").length > 0) &&
              this.tocDropdownMenu(n, a.tocTitle),
            "" !== a.tocContainer &&
              n.find(".editormd-toc-menu, .editormd-markdown-toc").remove()),
          a.previewCodeHighlight &&
            (n.find("pre").addClass("prettyprint linenums"), prettyPrint()),
          t.isIE8 ||
            (a.flowChart && n.find(".flowchart").flowChart(),
            a.sequenceDiagram &&
              n.find(".sequence-diagram").sequenceDiagram({ theme: "simple" })),
          a.tex)
        ) {
          var g = function () {
            n.find("." + t.classNames.tex).each(function () {
              var t = e(this);
              katex.render(
                t.html().replace(/&lt;/g, "<").replace(/&gt;/g, ">"),
                t[0]
              ),
                t.find(".katex").css("font-size", "1.6em");
            });
          };
          !a.autoLoadKaTeX || t.$katex || t.kaTeXLoaded
            ? g()
          ...
          t.isIE8
            ? (r.onreadystatechange = function () {
                r.readyState &&
                  ...
                  ((r.onreadystatechange = null), t.loadFiles.js.push(e), i());
              })
            : (r.onload = function () {
      ...
      (t.createDialog = function (i) {
        ...
        "" !== i.title &&
          ((h +=
            ...
            a +
            'dialog-header"' +
            (i.drag ? ' style="cursor: move;"' : "") +
            ">"),
          (h +=
            '<strong class="' + a + 'dialog-title">' + i.title + "</strong>"),
          (h += "</div>")),
          i.closed &&
            (h +=
              '<a href="javascript:;" class="fa fa-close ' +
          ...
          (i.footer || "string" == typeof i.footer) &&
            (h +=
              '<div class="' +
              a +
              'dialog-footer">' +
              ("boolean" == typeof i.footer ? "" : i.footer) +
              "</div>"),
          (h += "</div>"),
          (h +=
            '<div class="' + a + "dialog-mask " + a + 'dialog-mask-bg"></div>'),
          (h +=
            '<div class="' +
            a +
            "dialog-mask " +
        ...
        (d.lockScreen = function (t) {
          return (
            i.lockScreen &&
              (e("html,body").css("overflow", t ? "hidden" : ""), r.resize()),
            d
          );
        }),
          (d.showMask = function () {
        ...
        if (
          ...
          e(window).resize(u),
          d
            .children("." + a + "dialog-close")
            .bind(c("click", "touchend"), function () {
          ...
          for (var g in i.buttons) {
            var p = i.buttons[g],
              m = a + g + "-btn";
            f.append(
              '<button class="' + a + "btn " + m + '">' + p[0] + "</button>"
            ),
              (p[1] = e.proxy(p[1], d)),
        ...
        if ("" !== i.title && i.drag) {
          ...
          i.mask ||
            k.bind(c("click", "touchend"), function () {
          ...
          var b = function (e) {
            ...
            y = function (t) {
              ...
              r >= 0
                ? r + d.width() <= e(window).width()
                  ? (i = t.clientX - w)
                  : ((i = e(window).width() - d.width()),
                    (document.onmousemove = null))
                : ((i = 0), (document.onmousemove = null)),
                n >= 0
                  ? (o = t.clientY - v)
                  : ((o = 0), (document.onmousemove = null)),
