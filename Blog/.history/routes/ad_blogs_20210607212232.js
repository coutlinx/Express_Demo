...
router.post("/search",(req,res)=>{
  ...
  config.db.query("select * from essay where (article_classify =  ? and article_title like ?) or  article_classify = ?",[req.body.id,req.body.title,req.body.title],(err,restult,fild)=>{
    if(err != null){
      console.log(err);
    }else{
