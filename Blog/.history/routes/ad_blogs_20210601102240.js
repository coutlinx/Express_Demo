...
router.post("/search",(req,res)=>{
  config.db("select * from essay where article_classify = (select sort_name from classify where id = ?) and article_title = ?"[req.body.typeId,req.body.title],(err,restult,fild)=>{
    if(err != null){
      console.log(err);
    }else{
