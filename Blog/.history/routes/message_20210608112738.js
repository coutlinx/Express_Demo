...
router.post('/push',(req,res)=>{
  ...
  config.db.query("select use_id from user where use_name =?"[req.session.user.name])
  config.db.query("insert into message_board(use_id,comment_date,comment_content) value(?,?,?)"[])
})
