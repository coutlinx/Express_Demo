...
router.post("/compile",(req,res)=>{
  if(req.body.Title != undefined){
    config.db.query("select article_md,article_title,article_type_creat,article_photo,article_photo,article_content from essay where article_title = ? and article_date = ?",[req.body.Title,req.body.Time],(err,restults,fil)=>{
      if  (err != null){
        console.log(err)
      }else{
