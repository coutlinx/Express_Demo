...
router.post("/search",(req,res)=>{
  ...
  config.db.query("select * from essay where (article_classify =  ? and article_title like ?) or article_classify = ? or article_title like ?",[req.body.id,req.body.title],(err,restult,fild)=>{
    if(err != null){
      console.log(err);
    }else{
