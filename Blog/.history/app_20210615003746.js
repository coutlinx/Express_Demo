...
var adfriendsenewRouter = require('./routes/adfriends');
var adfriendsenewRouter = require('./routes/adfriendsinput');
var app = express();
...
app.use('/admin/friendlinks-input',typesinputRouter);
app.use('/admin/types-new',typesrenewRouter);
app.use('/admin/friendlinks',adfriendsenewRouter);
